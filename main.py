...
from regulamentos_diferentes import RegulamentosDiferentes
from webscrapingF1 import WebscrapingF1
from dist_e_plots import Dist_e_plots
...
class Main:
    ...
    if __name__ == '__main__':
        ...
        for temporada in temporadas:
            ...
            equipes.dataframeEquipes(temporada)
